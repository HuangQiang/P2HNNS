...
// -----------------------------------------------------------------------------
BH_Hash::~BH_Hash()                 // destructor
{
}

// -----------------------------------------------------------------------------
void BH_Hash::get_sig_data(         // get signature of data
    const float *data,                  // input data
...
// -----------------------------------------------------------------------------
void BH_Hash::get_sig_query(        // get signature of query
...
// -------------------------------------------------------------------------
int BH_Hash::nns(                   // point-to-hyperplane NNS
    int   cand,                         // #candidates
    const float *data,                  // input data
    const float *query,                 // input query
